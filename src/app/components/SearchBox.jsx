...
export default function SearchBox() {
  ...
  return (
    <form onSubmit={handleSubmit} className='max-w-6xl mx-auto flex justify-between items-center px-5'>
        <input value={search} onChange={(e)=>setSearch(e.target.value)} type="text" placeholder='Search Keywords...' className='w-full h-14 rounded-lg placeholder-gray-500 outline-none bg-transparent flex-1' />
